...
Red6-Finallauf & YOLOv8m, FCOS & 2.147 & 10 & 2 & AMD Radeon PRO W7800 48GB \\
RCNN-Guardlauf & Faster R-CNN MobileNetV3-FPN & 644 & 1 & 2 & AMD Radeon PRO W7800 48GB \\
\bottomrule
\end{tabular}}
\vspace{0.5em}
...
Faster R-CNN MobileNetV3 red20 ep1 & 12,9 min & 73 MB & 105\,\textdegree C-/8h-Guard, max. 88\,\textdegree C Junction \\
\bottomrule
\end{tabularx}
\vspace{0.15em}
\includegraphics[width=\textwidth,height=0.24\textheight,keepaspectratio]{imglib/face_model_lab/lernkurven_loss_accuracy.png}
\vspace{0.05em}
\tiny Rohdaten: Trainingshistorien und YOLO-Results aus \texttt{model\_results/} und \texttt{trained\_models/yolo\_runs/}.
\end{frame}
